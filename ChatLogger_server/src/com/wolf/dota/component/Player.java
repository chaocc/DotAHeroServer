...
public class Player {
	...
	private void initPlayerFromPlist(int id) {
		...
		// hp = hpLimit =
		// Integer.parseInt(hero.get("healthPointLimit").getValue().toString());
		// sp = spLimit =
		// Integer.parseInt(hero.get("manaPointLimit").getValue().toString());
		// handCardLimit =
		// Integer.parseInt(hero.get("handSizeLimit").getValue().toString());
		// heroName = hero.get("heroName").getValue().toString();
		// heroType =
		// Integer.parseInt(hero.get("heroAttribute").getValue().toString());
