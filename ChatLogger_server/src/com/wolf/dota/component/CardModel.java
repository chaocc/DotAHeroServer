...
public enum CardModel implements Params {
    ...
    _37(37, "速度之靴_W", CardModel.function_id_flame_attack, "梅花8", 8, 8 + CardModel.suit_club),
    _38(38, "菲丽丝之戒_W", CardModel.function_id_flame_attack, "梅花9", 9, 9 + CardModel.suit_club),
    _39(39, "闪避护符_W", CardModel.function_id_flame_attack, "梅花10", 10, 10 + CardModel.suit_club),
    ...
    _70(70, "散失之刃_W", CardModel.kPlayingCardDiffusalBlade, "方块A", 1, 1 + CardModel.suit_diamond),
    _71(71, "洛萨之锋_W", CardModel.kPlayingCardLotharsEdge, "方块2", 2, 2 + CardModel.suit_diamond),
    _72(72, "冰魄之眼_W", CardModel.kPlayingCardEyeOfSkadi, "方块3", 3, 3 + CardModel.suit_diamond),
    _73(73, "黯灭之刃_W", CardModel.kPlayingCardStygianDesolator, "方块4", 4, 4 + CardModel.suit_diamond),
    _74(74, "散夜对剑_W", CardModel.kPlayingCardSangeAndYasha, "方块5", 5, 5 + CardModel.suit_diamond),
    _75(75, "攻击之爪_W", CardModel.kPlayingCardBladesOfAttack, "方块6", 6, 6 + CardModel.suit_diamond),
    _76(76, "恶魔刀锋_W", CardModel.kPlayingCardDemonEdge, "方块7", 7, 7 + CardModel.suit_diamond),
    _77(77, "圣者遗物_W", CardModel.kPlayingCardSacredRelic, "方块8", 8, 8 + CardModel.suit_diamond),
    _78(78, "刃甲_W", CardModel.kPlayingCardBladeMail, "方块9", 9, 9 + CardModel.suit_diamond),
