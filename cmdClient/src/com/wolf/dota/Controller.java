...
import com.wolf.dota.values.Code;
import com.wolf.dota.values.Commands;
import com.wolf.dota.values.Params;
...
public class Controller implements Code, Params, Commands {
    ...
    private void showChat(String message) {
        ...
        if (player != null && player.getHandCards() != null) {
            System.out.println("my cards : " + Arrays.toString(player.getHandCards().toArray()));
        }
