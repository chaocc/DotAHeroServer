...
public interface c {
    ...
    public interface action {
        ...
        String update_table_info = "update_table_info";
        String update_player_property = "update_player_info"; // update
                                                              // player
                                                              // property
        String choosing = "choosing";
        String count_down = "counting_down";
        String update_player_list_info = "update_player_list_info";
        
        String chose_hero = "chose_hero";
        String init_hand_cards = "init_player_info_hand_cards";
        String update_hand_cards = "update_player_info_hand_cards";
        // String update_hand_cards_count = "update_hand_cards_count";
        String choosing_from_hand = "choosing_from_hand";
        String choosing_to_evade = "choosing_to_evade";
        String cutted = "update_table_cutted";
        String turn_to_player = "turn_to_player";
        String normal_attack = "normal_attack";
        String decided = "decided";
        String choosing_from_showing = "choosing_from_showing";
        String choosing_to_drop = "choosing_to_drop";
        String choosing_from_color = "choosing_from_color";
        String choosing_from_suits = "choosing_from_suits";
        String drop_card_stage = "drop_card_stage";
        
        String table_card_to_get = "table_card_to_get";
        String choosing_from_another = "choosing_from_another";
        String ordering = "ordering";
        String choosing_from_list = "choosing_from_list";
    }
