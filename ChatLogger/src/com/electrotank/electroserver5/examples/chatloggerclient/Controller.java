...
import com.electrotank.electroserver5.examples.chatloggerclient.constants.Code;
import com.electrotank.electroserver5.examples.chatloggerclient.constants.Commands;
import com.electrotank.electroserver5.examples.chatloggerclient.constants.Params;
...
public class Controller implements Code, Params, Commands {
    ...
    public void onPluginMessageEvent(EsPluginMessageEvent e) {
        ...
        if (requireAction == ac_require_draw) {
            obj.setInteger(code_action, ACTION_DRAW_CARDS);
    ...
    private EsObject getObj(EsPluginMessageEvent e) {
        ...
        requireAction = obj.getInteger(code_client_action_required, -1);
        log("" + currentAction);
    ...
    public void onJoinRoomEvent(EsJoinRoomEvent e) {
        ...
        me = es.getManagerHelper().getUserManager().getMe();
    ...
    private void showChat(String message) {
        ...
        view.showChat(player.getHandCards().toString());
